...
export const SkeletonTicker: React.FC = () => (
    <div className="h-10 flex items-center justify-center border-y border-border bg-muted/30 mb-6 w-full animate-pulse">
        <div className="h-3 w-64 bg-muted rounded" />
    </div>
);

export const SkeletonCardsList: React.FC<{ count?: number, className?: string }> = ({ count = 4, className = "grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8" }) => (
